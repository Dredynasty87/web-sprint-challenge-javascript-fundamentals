...
function greeting(Thomas, Smart){
  return `Hello ${"Thomas"} ${"Smart"} nice to meet you!`
  }
...
CuboidMaker.prototype.sufaceArea = function(){
    let sufaceArea = 2 * (this.length * this.width * this.height)
    return sufaceArea
}
